...
public class ImageController {
    ...
    public String createImage(Model model,@RequestParam("file") MultipartFile file, @RequestParam("tags") String tags, Image newImage, HttpSession session) throws IOException {
    ...
    public String editImageSubmit( Model model,@RequestParam("file") MultipartFile file, @RequestParam("imageId") Integer imageId,@RequestParam("tags") String tags, Image updatedImage, HttpSession session) throws IOException {
        Image image = imageService.getImage(imageId);
    ...
    public String deleteImageSubmit(Model model ,@RequestParam(name = "imageId") Integer imageId) {
